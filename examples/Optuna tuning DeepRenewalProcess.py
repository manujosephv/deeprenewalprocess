...
from models.deeprenewal._datasets import get_dataset
...
wandb.init(name="OptunaRunDeepRenewal_v8", project ="DeepRenewal")
...
def get_deeprenewal_from_trial(trial, trainer):
    ...
    forecast_type = trial.suggest_categorical("forecast_type", ["exact","hybrid","flat"])
